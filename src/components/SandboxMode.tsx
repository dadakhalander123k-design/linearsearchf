    ...
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-6 font-sans animate-page-enter">
      ...
      <div className="flex items-center justify-start">
        <button
          ...
          className="btn-modern-secondary px-4 sm:px-5 py-2.5 text-xs font-semibold flex items-center gap-2 cursor-pointer shadow-xs select-none hover:border-indigo-300 dark:hover:border-purple-500/40 transition-all group"
        >
          <ArrowLeft className="w-4 h-4 text-indigo-600 dark:text-purple-400 group-hover:-translate-x-1 transition-transform" />
