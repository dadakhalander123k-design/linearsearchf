...
export const LinearSearchLab: React.FC<LinearSearchLabProps> = () => {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-6 font-sans animate-page-enter">
      ...
      <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/20 rounded-3xl p-6 sm:p-8 shadow-xs">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4 border-b border-slate-100 dark:border-purple-500/15 pb-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 dark:bg-purple-950/60 text-indigo-700 dark:text-purple-300 text-xs font-bold font-mono uppercase tracking-wider rounded-lg border border-indigo-200 dark:border-purple-500/30">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm sm:text-base font-semibold text-indigo-600 dark:text-purple-300">
      ...
      <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/20 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-100 dark:border-purple-500/15">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 font-mono">
              <button
                ...
                className="w-8 h-8 rounded-lg border border-slate-200 dark:border-purple-500/30 text-slate-700 dark:text-slate-200 font-bold hover:bg-slate-100 dark:hover:bg-purple-950/40 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer transition-all"
              >
                -
              </button>
              <div className="px-4 py-1.5 bg-slate-100 dark:bg-[#080D1F] border border-slate-200 dark:border-purple-500/30 rounded-lg text-sm font-bold text-slate-900 dark:text-white text-center min-w-[50px]">
                {arraySize}
              </div>
              <button
          ...
          <div className="flex flex-wrap items-center gap-2 pt-2 sm:pt-0">
            ...
            >
              <Shuffle className="w-3.5 h-3.5 text-indigo-600 dark:text-purple-400" />
            ...
            {arrayElements.map((el, idx) => (
              <div key={idx} className="flex flex-col items-center">
                ...
                <input
                  ...
                  placeholder="0"
                  className="w-full text-center py-2 px-1 bg-white dark:bg-[#080D1F] border border-slate-300 dark:border-purple-500/30 rounded-xl font-mono font-bold text-sm text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500/40"
                />
              </div>
            ))}
          </div>
        ...
        <div className="pt-2 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-slate-100 dark:border-purple-500/15">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <input
              ...
              className="w-28 text-center py-2 px-3 bg-white dark:bg-[#080D1F] border border-indigo-300 dark:border-purple-500/40 rounded-xl font-mono font-extrabold text-indigo-600 dark:text-purple-300 text-base focus:outline-none focus:ring-2 focus:ring-indigo-500/40"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            {searchState === 'idle' ? (
              <button
                ...
                onClick={startSearch}
                className="btn-modern-primary bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 text-xs font-bold flex items-center gap-2 cursor-pointer shadow-md"
              >
      ...
      <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/20 rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
        <div className="flex flex-wrap items-center justify-between gap-4 pb-3 border-b border-slate-100 dark:border-purple-500/15">
          ...
          <div className="flex flex-wrap items-center gap-3 font-mono text-xs">
            <span className="text-slate-500">Target: <strong className="text-indigo-600 dark:text-purple-400">{targetInput || '—'}</strong></span>
            ...
            <span className="text-slate-500">Comparisons: <strong className="px-2 py-0.5 bg-indigo-600 text-white rounded-md">{comparisons}</strong></span>
              ...
              <strong
                className={`uppercase font-bold ${
                  searchState === 'found'
                    ...
                    ? 'text-indigo-600 dark:text-purple-400 animate-pulse'
                    : 'text-slate-500'
                }`}
              >
              ...
              return (
                <div key={idx} className="flex flex-col items-center">
                  ...
                  <div className="h-7 flex items-center justify-center font-mono font-bold text-[11px]">
                    {isCurrent ? (
                      <div className="flex flex-col items-center text-indigo-600 dark:text-purple-400 animate-bounce">
                  ...
                  <div
                    id={`visual-cell-${idx}`}
                    className={`relative w-14 sm:w-18 h-20 sm:h-24 rounded-2xl border-2 flex flex-col items-center justify-center select-none transition-all duration-300 ${
                      isMatch && (searchState === 'found' || isExamined)
                        ...
                        : isMismatch
                        ? 'bg-slate-50 dark:bg-[#080D1F] border-slate-300 dark:border-purple-500/20 text-slate-400 dark:text-slate-500 opacity-75'
                        : isCurrent
                        ? 'bg-indigo-50 dark:bg-purple-950/60 border-indigo-600 dark:border-purple-500 text-indigo-900 dark:text-white shadow-md scale-105 ring-4 ring-indigo-500/20'
                        : 'bg-white dark:bg-[#0B1228] border-slate-200 dark:border-purple-500/30 text-slate-800 dark:text-slate-200 opacity-90'
                    }`}
                  >
                    <span className="text-[10px] font-mono font-bold text-slate-400 dark:text-slate-500 mb-1">
                      [{idx}]
                    ...
                    <div className="mt-1 text-[9px] font-mono font-bold">
                      {isMatch && (searchState === 'found' || isExamined) ? (
                        ...
                        <span className="text-indigo-600 dark:text-purple-300 animate-pulse">?</span>
                      ) : (
        ...
        {searchState === 'searching' && (
          <div className="pt-4 border-t border-slate-100 dark:border-purple-500/15 flex flex-wrap items-center justify-between gap-4 animate-fadeIn">
            <div className="flex items-center gap-2">
              <button
        ...
        <div className="p-4 bg-indigo-50/70 dark:bg-purple-950/30 border border-indigo-100 dark:border-purple-500/20 rounded-2xl flex items-start gap-3">
          <Lightbulb className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
          <div className="space-y-1">
            <span className="text-xs font-bold text-indigo-900 dark:text-purple-200 uppercase font-mono tracking-wider block">
              Step Explanation
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/20 rounded-3xl p-6 shadow-xs flex flex-col justify-between space-y-4">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 pt-2">
              <input
                ...
                placeholder="Count"
                className="w-24 text-center py-2 px-2 bg-slate-50 dark:bg-[#080D1F] border border-slate-300 dark:border-purple-500/30 rounded-xl font-mono font-bold text-xs"
              />
              <button
        ...
        <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/20 rounded-3xl p-6 shadow-xs space-y-3">
          ...
          <ol className="space-y-2 text-xs text-slate-600 dark:text-slate-300 font-medium list-decimal list-inside">
            <li className={searchState === 'searching' && currentIndex === 0 ? 'text-indigo-600 dark:text-purple-300 font-bold' : ''}>
              Start at the first element (index 0)
            </li>
            <li className={searchState === 'searching' ? 'text-indigo-600 dark:text-purple-300 font-bold' : ''}>
        ...
        {/* Pseudocode Panel */}
        <div className="bg-white dark:bg-[#0B1228] border border-slate-200 dark:border-purple-500/20 rounded-3xl p-6 shadow-xs space-y-3 font-mono">
          ...
          <pre className="text-[11px] p-3 bg-slate-900 text-indigo-300 rounded-xl leading-relaxed overflow-x-auto">
