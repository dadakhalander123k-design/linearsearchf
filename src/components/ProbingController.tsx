...
export const ProbingController: React.FC<ProbingControllerProps> = ({
  ...
  return (
    <div className="w-full max-w-2xl mx-auto bg-white dark:bg-[#111827] border border-slate-200/90 dark:border-blue-500/25 rounded-2xl p-5 sm:p-6 shadow-sm dark:shadow-[0_8px_30px_rgba(0,0,0,0.35)] font-sans transition-all">
      {/* Top Header */}
      ...
      <div className="space-y-4">
        <div className="bg-slate-50/80 dark:bg-[#0F172A] border border-slate-200 dark:border-blue-500/20 rounded-xl p-4 shadow-2xs">
