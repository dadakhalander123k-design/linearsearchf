...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1120] text-slate-900 dark:text-[#F8FAFC] font-sans flex antialiased selection:bg-[#2563EB] dark:selection:bg-blue-600 selection:text-white transition-colors duration-300">
                ...
                {currentLevelIndex >= 5 ? (
                  ...
                  <div key={`game-level-${currentLevel.id}`} className="flex flex-col gap-6 animate-chapter-switch">
                    ...
                    <div className="text-center max-w-2xl mx-auto font-sans">
                      <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 dark:bg-blue-950/60 border border-indigo-100 dark:border-blue-500/30 text-indigo-700 dark:text-blue-300 text-xs font-bold mb-2 uppercase font-mono rounded-lg">
